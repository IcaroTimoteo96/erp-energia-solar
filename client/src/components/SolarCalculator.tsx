  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">{t.calculator.monthlyUsage}</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">{t.calculator.peakSunHours}</label>
          <input
            type="number"
            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">{t.calculator.panelWattage}</label>
          <input
            type="number"
            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">{t.calculator.energyRate}</label>
          <input
            type="number"
            step="0.01"
            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
      ...
      {result && (
        <div className="grid grid-cols-3 gap-4 bg-orange-50 p-4 rounded-lg border border-orange-100">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500">{t.calculator.systemSize}</p>
          ...
          <div className="text-center border-l border-orange-200">
            ...
            <p className="text-xs text-gray-500">{t.calculator.panelsNeeded}</p>
          ...
          <div className="text-center border-l border-orange-200">
            ...
            <p className="text-xs text-gray-500">{t.calculator.savings}</p>
